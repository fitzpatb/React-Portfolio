      ...
      <div className="container my-border col-lg-9 col-md-10 col-sm-11 col-xs-11">
        ...
        <div className="row border-top">
          <div className="col-12">
            <img className="about" src="assets/images/me.jpeg" alt="Brett Fitzpatrick" width="250px" height="250px" />
            <p>
        ...
        <div className="row border-top">
          ...
          <div className="col-12">
            <img className="family" src="assets/images/Family.png" alt="Me and my family" width="250px" height="250px" />
